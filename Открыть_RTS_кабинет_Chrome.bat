...
start "Tender Collector Browser" "%RTS_BROWSER_EXE%" --remote-debugging-address=127.0.0.1 --remote-debugging-port=9222 --user-data-dir="%RTS_PROFILE%" --no-first-run --no-default-browser-check "https://223.rts-tender.ru/supplier/auction/Trade/Search.aspx#tradeSearchTitle" "https://www.rts-tender.ru/poisk/search?id=7a2edb26-ab8d-4fee-86b4-56514059add7" "https://agregatoreat.ru/lk/supplier/eat/purchases/active/all" "https://etp.gpb.ru/#log/maillist/223" "https://lk.roseltorg.ru/" "https://44.sberbank-ast.ru/tradezone/Supplier/ESPurchaseList.aspx" "https://utp.sberbank-ast.ru/Trade/List/BidListClose"
